...
const ToastWithButton = ({size}) => {
  return (
  <div className="sticky top-30 left-345 p-2 z-30 items-center flex-col w-full flex justify-end" style={{ backgroundColor: "#111827" }}>
  <Toast className="rounded-md p-2 flex items-center w-full max-w-5xl ">
    ...
    <div className="flex flex-col items-center justify-center w-full max-w-5xl">
        <span className="poppins mb-1 text-sm font-semibold text-gray-900 dark:text-white">{size} yard size selected</span>
